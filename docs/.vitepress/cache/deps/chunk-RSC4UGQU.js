import {
  BaseDirective
} from "./chunk-KVFVPEWG.js";
import {
  BaseStyle
} from "./chunk-PKF4FVKV.js";
import {
  O,
  R,
  W2 as W
    ...
    bind: function bind(el, binding) {
      ...
      el.$_pstyleclass_clicklistener = function() {
        if (binding.value.toggleClass) {
          if (R(target, binding.value.toggleClass)) O(target, binding.value.toggleClass);
      ...
      if (binding.value.enterActiveClass) {
        if (!target.$_pstyleclass_animating) {
          ...
          if (binding.value.enterActiveClass.includes("slidedown")) {
            ...
            O(target, binding.value.hiddenClass || binding.value.enterFromClass);
          ...
          if (binding.value.enterFromClass) {
            O(target, binding.value.enterFromClass);
          }
          target.$p_styleclass_enterlistener = function() {
            O(target, binding.value.enterActiveClass);
      ...
      if (binding.value.leaveActiveClass) {
        if (!target.$_pstyleclass_animating) {
          ...
          if (binding.value.leaveFromClass) {
            O(target, binding.value.leaveFromClass);
          }
          target.$p_styleclass_leavelistener = function() {
            O(target, binding.value.leaveActiveClass);
...
//# sourceMappingURL=chunk-RSC4UGQU.js.map
